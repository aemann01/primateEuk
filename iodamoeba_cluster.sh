...
#now want to get the full database for our iodamoeba sequences
#eukref pipeline continued
python2.7 /parfreylab/mann/primateEuk/eukref_trees/eukref_gbretrieve.py -i full.fa -dbnt /parfreylab/shared/databases/NCBI_NT/NT_06.08.2018/nt -dbsi Reference_DB.fas -n 100 -p 8 -g Iodamoeba -m megablast -idsi 75 -idnt 90 -td tax_d.bin
